...
//    header.fileSize = (height * width * 2) + 54;
...
//    [data appendData:[self bitmapData]];
    ...
    [data appendData:[self convertBitmap_24bit_dataWithBitmap_32bit_data:[self bitmapData]]];
...
//        if (i % 4 == 0) {
//            if (i != 0) {
//                int hight = (value & 0xFF00) >> 8;
//                int low = value & 0x00FF;
//                [bitmap_16bit_mdata appendBytes:&hight length:1];
//                [bitmap_16bit_mdata appendBytes:&low length:1];
//            }
//        }else if (i % 4 == 1) {//B
//            int b = p[i] / 255.0 * 31;
//            value = b;
...
- (NSData *)convertNSDataFromHexString:(NSString *)perPixelString {
    NSString *strData = perPixelString;
